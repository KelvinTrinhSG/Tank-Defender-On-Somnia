...
public class NFTTokenGateManager : MonoBehaviour
{
    ...
    public async void Login()
    {
        ...
        Debug.Log(Address);
        Contract contract = ThirdwebManager.Instance.SDK.GetContract(ContractConfig.NFT_CONTRACT);
    ...
    public async void ClaimGold()
    {
        ...
        var contract = ThirdwebManager.Instance.SDK.GetContract(ContractConfig.GOLD_CONTRACT);
    ...
    {
        Address = await ThirdwebManager.Instance.SDK.Wallet.GetAddress();
        var contract = ThirdwebManager.Instance.SDK.GetContract(ContractConfig.TOKEN_CONTRACT);
